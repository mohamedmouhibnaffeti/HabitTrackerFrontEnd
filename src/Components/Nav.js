            ...
            <header>
                <nav>
                    ...
                    <ul>
                        ...
                        <li><div className='Item'><NavLink style={NavStyles} to='/Calories'><b>Calories Tracker</b></NavLink></div></li>
                        <li><div className='Item'><NavLink style={NavStyles} to='/Contact'><b>Contact</b></NavLink></div></li>
                        <li><div className='Item'><NavLink style={NavStyles} to='/Profile'><b>Profile</b></NavLink></div></li>
